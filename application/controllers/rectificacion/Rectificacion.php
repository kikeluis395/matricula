...
class Rectificacion extends CI_Controller {
		...
		if($this->session->has_userdata('usuario')){
            ...
            if($usuario->estado == 1)
			{
                ...
                if($matricula)
                {
                    ...
                    if($activacionRectificacion->estado == 1)
                    {

                        $periodoActual = date('Y') . '-I';

                        if($activacionRectificacion->periodo == 2){
                    ...
                    // ------------- SI ESTAN ACTIVADOS LOS HORARIOS ----------------------
                        ...
                        if(empty($listCursosLlevados))
                        {
                            ...
                            $this->load->view("rectificacion/rectificacion_view", $data);
                        ...
                        }else
                        {
                                            ...
                                            if($curso_llevado)
                                            {
                                                ...
                                                if($curso_llevado->estado != 'APROBADO' && $curso_llevado->estado != 'EN CURSO')
                                                {
                                                    ...
                                                    if($cursoPermitido->num_ciclo == 1)
                                                    {
                                                        ...
                                                        if($activacionRectificacion->periodo == 1)
                                                        {
                            ...
                            }else
                            {
                                ...
                                }else
                                {
                                    ...
                                    for($ciclo = $activacionRectificacion->periodo; $ciclo <=$numCicloMax; $ciclo +=2)
                                    {
                    ...
                    }else
                    {
                        ...
                        $this->load->view("rectificacion/rectificacion_activacion", $data);
                    }
                }else
                {
                    ...
                    $this->load->view("rectificacion/rectificacion_no_matricula_view", $data);
                }
            ...
            }else
            {
                ...
                $this->load->view("rectificacion/alumno_no_activo_view", $data);
    ...
    public function VerHorariosDisponiblesTodosRectificacion()
    {
        ...
        $this->load->view("rectificacion/rectificacion_horarios_disponibles_todos_view", $data);

    } 

    public function VerHorariosDisponiblesRectificacion(){
        ...
        $this->load->model("HorariosModel");
        $listHorariosDisponibles = $this->HorariosModel->getHorariosByCursoRectificacion($cod_curso, $seccion);
        $listCountGroupSeccion = $this->HorariosModel->getCountGroupByCurso($cod_curso);
        ...
        $this->load->view("rectificacion/rectificacion_horarios_disponibles_view", $data);
    ...
    public function DejarCurso(){
        ...
        $this->load->model("HorariosModel");
        $listHorarioCurso = $this->HorariosModel->getHorariosByCursoAndPeriodoAndSeccionRectificacion($cod_curso, $seccion, $periodoActual);

        $horario_curso = reset($listHorarioCurso);

        $this->load->model("Cursos_llevados");
        $this->Cursos_llevados->deleteCursosLlevadosByListHorarioCurso($listHorarioCurso, $usuario->cod_alumno);

        $this->load->model("HorarioAlumnoModel");
        $this->HorarioAlumnoModel->deleteHorarioAlumnoByListHorarioCurso($listHorarioCurso);

        $this->HorariosModel->modifiyCuposByListHorariosCursoRectificacion($listHorarioCurso, $horario_curso->cupos);


        // --------------- OBTENIENDO LOS CURSOS MATRICULADOS --------------------------
    ...
    public function VerCursosPermitidos(){
                ...
                $activacionRectificacion = $this->ActivacionModel->getActivacionByCodigo($cod_activacion);
                   ...
                   // ------------- SI ESTAN ACTIVADOS LOS HORARIOS ----------------------
                    ...
                    if(empty($listCursosLlevados))
                    {
                        ...
                        $this->load->view("rectificacion/rectificacion_horarios_permitidos_view", $data);
    ...
    public function RegistrarHorariosCambio()
    {
        $cod_activacion = 2;
        $this->load->model("ActivacionModel");
        $activacionRectificacion = $this->ActivacionModel->getActivacionByCodigo($cod_activacion);
        ...
        $seccion_anterior = (string)$this->input->post('seccion_anterior');
        ...
        $listHorarioCurso = $this->HorariosModel->getHorariosByCursoAndPeriodoAndSeccionRectificacion($cod_curso, $seccion_anterior, $periodoActual);
        ...
        // ------------------- INSERTANDO LOS HORARIOS ELEGIDOS ------------------------
            

            $list_horario_curso = $this->HorariosModel->getHorariosCursosByCursoAndSeccion($cod_curso, $seccion);

            $horario_curso = reset($list_horario_curso);
