...
<head>
    ...
    <title>Administrador | Rectificacion</title>
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Activar rectificacion</li>
                            </ol>
                        </div><!-- /.container-fluid -->
                    </div>
                </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-11 col-lg-11 col-sm-11">
                                    <h2>Activar rectificacion</h2>
                                    <span>Cambiar de estado en las activaciones para el periodo de la rectificacion</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                        <?php 
                                                            ...
                                                            if($activacionRectificacion->estado == 1)
                                                            {
                                                                ...
                                                                echo "<button type='button' class='btn btn-warning' onclick='CambiarEstado(\"".base_url()."\",\"".$activacionRectificacion->estado."\",\"Rectificacion\")'>Desactivar</button>";

                                                            }else
                                                            {

                                                                echo "<button type='button' class='btn btn-success' onclick='CambiarEstado(\"".base_url()."\",\"".$activacionRectificacion->estado."\",\"Rectificacion\")'>Activar</button>";
