                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Activar horarios</li>
                            </ol>
                        </div><!-- /.container-fluid -->
                    </div>
                </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-11 col-lg-11 col-sm-11">
                                    <h2>Activar horarios</h2>
                                    <span>Cambiar de estado en las activaciones para el periodo de los horarios</span>
                                </div>
                            </div>
                        </div>
                    </div>
