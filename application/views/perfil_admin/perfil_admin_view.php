                            ...
                            <div class="card" style="padding: 10px">
                                <div class="card-body">
                                    ...
                                    <div class="row" style="margin-top: 15px">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-3 col-form-label">Año de nacimiento:</label>
                                            <div class="col-sm-9">
                                              <label for="staticEmail" class="col-sm-9 "><?php echo $usuario->anio_nacimiento?></label>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-3 col-form-label">Sexo:</label>
                                            <div class="col-sm-9">
                                              <label for="staticEmail" class="col-sm-9 "><?php echo $usuario->sexo?></label>
                                            </div>
                                          </div>
                                        </div>
